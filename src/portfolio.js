...
const greeting = {
  ...
  title: "Hi all, I'm Yiyang, pronounced like 'E-young' ",
  subTitle: emoji(
    "A passionate Full Stack Software Developer 🚀 having an experience of building Web and Mobile applications"
  ),
  resumeLink:
    "https://drive.google.com/file/d/1-8KU2k8jzwY2Err6p4ylY3KcrCm8kfiI/view?usp=drive_link", // Set to empty to hide the button
...
const educationInfo = {
  ...
  schools: [
    ...
    },
    {
      ...
      logo: require("./assets/images/utoronto.png"),
      subHeader: "Master of Engineering in Computer Engineering",
      duration: "September 2024",
      desc: "focus on machine leraning, software design and data analysis ...",
      descBullets: ["Teaching Assistant"]
    }
  ]
};
  ...
  experience: [
    {
      ...
      companylogo: require("./assets/images/uoftcs.png"),
      date: "09/2024-current",
      desc: "Giving tutorials about software desgin, O-O, java, API, intelliJ, Git, Junit"
    },
    {
...
const resumeSection = {
  ...
  // Please Provide with Your Podcast embeded Link
  podcast: [
    "https://drive.google.com/file/d/1-8KU2k8jzwY2Err6p4ylY3KcrCm8kfiI/view?usp=drive_link"
  ],
  display: true // Set false to hide this section, defaults to true
};
...
const contactInfo = {
  ...
  number: "437-733-2442",
  email_address: "yiyangww@gmail.com"
};
